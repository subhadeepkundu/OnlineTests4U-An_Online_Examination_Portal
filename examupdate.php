...
<?php include('db_connect.php');
  ...
  if(isset($_POST['submit'])){
    ...
    else if (!is_numeric($ques)) 
    {
      ...
      $check=mysqli_query($conn,"SELECT * FROM examdetails WHERE ename='$name' AND examid!='$examid'");
      $checkrows=mysqli_num_rows($check);
      if($checkrows>0) {
        $dup = "Exam Name exists";
      } 
      else {  
       $query="UPDATE examdetails SET ename='$name',tlimit='$time',passmarks='$pass',noques='$ques' WHERE examid='$examid'";
        $res=mysqli_query($conn,$query);

        $updmsg="Data updated Successfully!!!";

        header("Location:examlist.php?insmsg=".$updmsg);
      }
    }
      ...
      <TR>
        <TD vAlign=top align=middle>
          ...
          <TABLE border=10 cellSpacing=0 cellPadding=0 width="100%" bgColor=#4e9258>
                              ...
                              <tr>
                                  <td bgcolor="#a74ac7" width="100%">
                                    <font size="2" face="Arial">
                                      <B> <asp:Label ID="lblname" runat="server" Text=""><a href="inst_dash.php" style="text-decoration: none;">DASHBOARD</a></asp:Label></B>
                                    </font>
                                  </td>
                              </tr>
                               <tr>
            ...
            <?php
            $examid= $_GET['examid'];
            $updt= "SELECT * FROM examdetails WHERE examid = '$examid'";
          ...
          <table border=0 cellSpacing=0 cellPadding=10 width="100%" bgcolor=#ffffff align=center>
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="name" class="form-control" Height="30px" placeholder="Exam Name" value="<?php echo $row['ename']; ?>">
               ...
               <tr>
                ...
                <td>
                  <input type="text" name="time" class="form-control" Height="30px" placeholder="Time Limit" value="<?php echo $row['tlimit']; ?>">
                ...
                <td>
                  <input type="text" name="pass" class="form-control" Height="30px" placeholder="Pass Marks" value="<?php echo $row['passmarks']; ?>">
               ...
               <tr>
                ...
                <td>
                  <input type="text" name="ques" class="form-control" Height="30px" placeholder="No. of Questions" value="<?php echo $row['noques']; ?>">
