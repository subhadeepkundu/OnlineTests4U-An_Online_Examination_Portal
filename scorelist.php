                      ...
                      <TR>
                        ...
                        <TD bgcolor=#ffffff vAlign=top width="61%" align=left>
                          ...
                          <TABLE border=0 cellSpacing=10 cellPadding=10 width="100%" bgColor=#bce954>
                            <TR>
                              <TD bgColor=#e0ffff width="100%">
                                <FONT size=5 face=Arial><b>Score List</b></FONT>
                              ...
                              <?php $results = mysqli_query($conn, "SELECT * FROM score ORDER BY stuid DESC"); ?>
                              ...
                              <table border=10 cellSpacing=10 cellPadding=0 width="100%" bgColor=#4e8975>
                                <tbody>
                                  <tr>
                                    ...
                                    <td bgColor=#e56e94 vAlign=top align=middle><font size=3><b>Student Name</b></font></td>
                                    ...
                                    <td bgColor=#e56e94 vAlign=top align=middle><font size=3><b>Marks Obtained</b></font></td>
                                  </tr>
                                  ...
                                  while ($rowf = mysqli_fetch_array($results)) { ?>
                                    ...
                                    $results3 = mysqli_query($conn, "SELECT * FROM registration WHERE id='$stuid' ");
                                  ...
                                  <tr>
                                    ...
                                    <td bgColor=#54c571 vAlign=top align=middle><?php echo $rowf3['name']; ?></td>
                                    <td bgColor=#54c571 vAlign=top align=middle><?php echo $rowf2['ename']; ?></td>
                                    <td bgColor=#54c571 vAlign=top align=middle><?php echo $rowf2['totmarks']; ?></td>
                                    <td bgColor=#54c571 vAlign=top align=middle><?php echo $rowf2['passmarks']; ?></td>
                                    <td bgColor=#54c571 vAlign=top align=middle><?php echo $rowf['marks']; ?></td>
