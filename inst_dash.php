...
else $instemail= $_SESSION["instemail"];
?>
              ...
              <TD vAlign=top align=middle>
                ...
                <FONT size=3 face=Arial><?php
                  ...
                  if (isset($_SESSION["stuemail"])) {?><a href="stu_dash.php"> <?php }
                    ...
                    <?php $results = mysqli_query($conn, "SELECT * FROM org where email='$instemail'"); 
                    ...
                    ?>
                        ...
                        <TD bgcolor=#ffffff vAlign=top width="61%" align=left>
                          <p align="right" style="font-size: 20px"><b>Hi,&nbsp; <?php echo $rowf['instname'];?></b><br>
                          <br><center><img src="instlogo.jpg" width="450" height="270"></center>
                        </TD>
                      </TR>
                    </TABLE>
