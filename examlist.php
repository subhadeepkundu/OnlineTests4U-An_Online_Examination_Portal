                          ...
                          <TABLE border=0 cellSpacing=10 cellPadding=10 width="100%" bgColor=#bce954>
                            <TR>
                              <TD bgColor=#e0ffff width="100%">
                                ...
                                <a  class="btn_sub" href="examdetails.php" id="btncancel" > Add New Exam</a><br>
                                <?php 
                              ...
                              <table border=10 cellSpacing=10 cellPadding=0 width="100%" bgColor=#4e8975>
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td bgColor=#54c571 vAlign=top align=middle><?php echo $rowf['ename']; ?></td>
                                    <td bgColor=#54c571 vAlign=top align=middle><?php echo $rowf['tlimit']; ?></td>
                                    <td bgColor=#54c571 vAlign=top align=middle><?php echo $rowf['noques']; ?></td>
                                    <td bgColor=#54c571 vAlign=top align=middle><?php echo $rowf['totmarks']; ?></td>
                                    <td bgColor=#54c571 vAlign=top align=middle><?php echo $rowf['passmarks']; ?></td>      
                                    <td bgColor=#54c571 vAlign=top align=middle>
                                        <a href="examupdate.php?examid=<?php echo $rowf['examid']; ?>">Edit </a> | 
                                        <a href="examdelete.php?examid=<?php echo $rowf['examid']; ?>">Delete </a>
