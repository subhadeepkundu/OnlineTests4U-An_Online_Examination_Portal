...
<br/><br/><b>TECHNOLOGIES USED:</b> The following are the technologies used for building the application:-
C•	<b>HTML:</b> Hypertext Markup Language is the standard markup language for creating web pages and web applications.
